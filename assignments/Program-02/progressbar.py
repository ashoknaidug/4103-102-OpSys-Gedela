...
import threading import Queue as queue import time class App(tk.Tk):
    def __init__(self):
        tk.Tk.__init__(self)
...
command=self.spawnthread)
    ...
    def checkqueue(self):
        while self.queue.qsize():
            try:
                ...
                pass class ThreadedClient(threading.Thread):
    ...
    def run(self):
        for x in range(1, 5):
            ...
            self.queue.put(msg) if __name__ == "__main__":
    app = App()
    app.mainloop()
